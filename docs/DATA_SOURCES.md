...
The deterministic normalized fixture is scoped to `config/local-dev.yaml`. The public-safe profile uses the bgp.tools bulk table export and sets an identifying HTTP User-Agent.
