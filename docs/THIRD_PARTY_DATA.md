...
The v0.1 public-safe profile uses RIR delegated stats and the bgp.tools bulk table export. It avoids CAIDA by default. Optional research profiles may have additional restrictions and should be documented before publication.
